...
const buttonVariants = cva("relative group border text-foreground mx-auto text-center rounded-full", {
  variants: {
    variant: {
      default: "bg-blue-500/5 hover:bg-blue-500/10 border-blue-500/30 hover:border-blue-500/50",
      solid:
        "bg-blue-500 hover:bg-blue-600 text-white border-blue-500 hover:border-blue-400 transition-all duration-200",
      ghost: "border-blue-500/30 bg-transparent hover:border-blue-500/50 hover:bg-blue-500/5",
    },
    size: {
      default: "px-7 py-1.5",
      sm: "px-4 py-0.5",
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, neon = true, size, variant, children, asChild, ...props }, ref) => {
    if (asChild) {
      return (
